...
var ScenarioWorld = /*#__PURE__*/function (_World) {
  ...
  function ScenarioWorld(options) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getToken", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var response, res;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _this.api.request.post('/login', {
              data: {
                username: 'admin',
                password: 'admin'
              }
          ...
          case 5:
            res = _context2.sent;
            return _context2.abrupt("return", _this.extractToken(res));
          case 7:
          case "end":
    ...
    _defineProperty(_assertThisInitialized(_this), "extractToken", /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(response) {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", response.token.toString());
            case 1:
            case "end":
