...
var jsonPayloadMappings = payloadFiles.reduce(function (payloadConfigAccumulator, file) {
  ...
  return _objectSpread(_objectSpread({}, payloadConfigAccumulator), {}, _defineProperty({}, key, payloadMappings));
}, {});
var worldParameters = {
